...
$sql = "CREATE TABLE IF NOT EXISTS solicitudes_baja (
    ...
    PDF_BLOB LONGBLOB,
    ARCHIVO_ADJUNTO_VALIDACION LONGBLOB,
    NOMBRE_ARCHIVO_VALIDACION VARCHAR(255),
    TIPO_ARCHIVO_VALIDACION VARCHAR(50),
    TAMAÑO_ARCHIVO_VALIDACION VARCHAR(50),
    FECHA_MODIFICACION_REVISION TIMESTAMP,
    FECHA_MODIFICACION_ACEPTADO_CANCELADO TIMESTAMP
);";
