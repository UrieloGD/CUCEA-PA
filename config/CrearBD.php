...
VALUES
    ...
    (2113456789, 'Sara', 'Robles', 'srobles@cucea.udg.mx', '123', 'Femenino', 1),
    (2114567890, 'Guillermo', 'Sierra', 'gsierraj@cucea.udg.mx', '123', 'Masculino', 1),
    (2115678901, 'Mariana', 'Ponce', 'mariana.ponce@cucea.udg.mx', '123', 'Femenino', 1),
    (2116789012, 'César', 'Mora', 'cesar.mora@cucea.udg.mx', '123', 'Masculino', 1),
    (2121234567, 'Alejandro', 'Campos', 'a.campos@cucea.udg.mx', '123', 'Masculino', 1),
    (2130192837, 'José', 'Sánchez', 'jsanchez@cucea.udg.mx', '123', 'Masculino', 1),
    (2140596871, 'Cristian', 'Alcantar', 'cristian.alcantar@cucea.udg.mx', '123', 'Masculino', 1),
    (2151234098, 'Alejandro', 'López', 'alejandro.lopez@cucea.udg.mx', '123', 'Masculino', 1),
...
$sql = "CREATE TABLE IF NOT EXISTS Data_Estudios_Regionales (
    ...
    CODIGO_PROFESOR VARCHAR(7) NOT NULL,
    NOMBRE_PROFES0R VARCHAR(60) NOT NULL,
    CATEGORIA VARCHAR(40) NOT NULL,
    DESCARGA VARCHAR(2) NOT NULL,
    CODIGO_DESCARGA VARCHAR(7) NOT NULL,
