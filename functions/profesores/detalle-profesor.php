...
if (isset($_POST['codigo_profesor'])) {
    ...
    if ($datos_profesor && !empty($materias)) {
        ...
        echo '<span class="close-D" onclick=\'cerrarModalDetalle()\'><i class="fa fa-times" aria-hidden="true"></i></span>';
        echo '<div class="alert alert-info" style="margin-top: 35px;">No se encontró información para este profesor.</div>';
    }
}
?>