...
if ($conexion->connect_error) {
    writeLog("Error de conexión a la base de datos: " . $conexion->connect_error);
...
if (isset($_FILES["file"]) && $_FILES["file"]["error"] == 0) {
    ...
    if ($usuario_id !== null) {
        try {
            ...
            if ($stmt === false) {
                writeLog("Error en la preparación de la consulta: " . $conexion->error);
            ...
            if ($successful_inserts > 0) {
                ...
                writeLog("No se pudo insertar ningún registro. Revise el log para más detalles.");
...
$output = ob_get_clean();
writeLog("Output antes de JSON: " . $output); // Para debugging
...
writeLog("Mensaje final enviado: " . $message); // Para debugging
