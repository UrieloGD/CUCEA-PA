...
<div class="solicitud-completa solicitud-visible" 
     data-departamento-id="<?php echo $solicitud['departamento_id']; ?>">
    ...
    <div class="info-sup" onclick="mostrarInformacion('contenedor-informacion-<?php echo $index; ?>', this.querySelector('.icono-despliegue i'))">
        ...
        <div class="nombre-dpto-solicitud">
            ...
            <span class="nombre-solicitud tipo-solicitud"><?php echo $solicitud['tipo']; ?></span>
        </div>
        <div class="nombre-dpto-solicitud">
            <span>Departamento:</span>
            <span class="nombre-departamento departamento-solicitud">
                <?php 
