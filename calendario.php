        ...
        <div class="left-column">
            <div class="header-calendar">
                ...
                <div class="events">
                    ...
                    <div class="event">
                    <div class="event-time">Hoy<br>15:00</div>
                    <div class="event-description">Reunión de revisión<br>de bases de datos</div>
                    </div>
                    <div class="event">
                    <div class="event-time">24 - 26 Jun<br>13:30</div>
                    <div class="event-description">Cierre de programación<br>académica</div>
                    </div>
                </div>
            </div>
        </div>
    ...
    while ($day <= $daysInMonth) {
        ...
        switch ($day) {
            ...
            case 10:
                ...
                $events = "<span class='event-indicator yellow'>Actividad 1</span>";
                break;
            case 15:
                $class = 'day-with-event';
                $events = "<span class='event-indicator yellow'>Actividad 2</span>";
                break;
            case 24:
                $class = 'day-with-event multiple-events';
                $events = "<span class='event-indicator green'>Actividad 3</span><span class='event-indicator lightblue'>Cierre PA</span>";
                break;
            case 25:
            case 26:
                $class = 'day-with-event';
                $events = "<span class='event-indicator lightblue'>Cierre PA</span>";
                break;
        }
