function descargarArchivo(departamentoId) {
    ...
    Swal.fire({
        ...
        didOpen: () => {
            ...
            fetch(`./functions/plantilla/descargarPlantilla.php?departamento_id=${departamentoId}`)
                .then(response => {
                    if (!response.ok) {
                ...
                .catch(error => {
                    ...
                    Swal.fire({
                        ...
                        text: error.message || 'No se pudo descargar la plantilla. Intente nuevamente.',
