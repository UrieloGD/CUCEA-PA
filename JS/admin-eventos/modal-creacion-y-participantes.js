document.addEventListener("DOMContentLoaded", function () {
  ...
  const btnCancelarCrearEvento = document.getElementById(
    "btnCancelarCrearEvento"
  );
  const btnAbrirModalParticipantes = document.getElementById(
    "abrirModalParticipantes"
  );
  const btnAbrirModalParticipantesEdicion = document.getElementById(
    "abrirModalParticipantesEdicion"
  );
  const btnConfirmarParticipantes = document.getElementById(
  ...
  const btnCancelarEditarEvento = document.getElementById(
    "btnCancelarEditarEvento"
  );
  ...
  function restaurarParticipantesSeleccionados() {
    const inputsOcultos = document.querySelectorAll(
      '#input-participantes input[type="hidden"]'
    );
  ...
  function mostrarParticipantesEdicion(participantes) {
    ...
    console.log(
      ...
      Array.from(participantesSeleccionados)
    );
  ...
  function cargarParticipantes() {
    fetch("./functions/admin-eventos/obtener-participantes.php")
      ...
      .then((data) => {
        participantesData = {}; // Reiniciar el objeto
        listaParticipantes.innerHTML = data
          .map((usuario) => {
            participantesData[usuario.Codigo] = usuario; // Almacenar datos del participante
            const isChecked = participantesSeleccionados.has(usuario.Codigo)
              ? "checked"
              : "";
            return `
                        <tr>
  ...
  function actualizarParticipantesSeleccionados() {
    ...
    actualizarTarjetasParticipantes(
      "participantes-seleccionados",
      "input-participantes",
      Array.from(participantesSeleccionados)
    );
  ...
  function actualizarParticipantesEdicion() {
    ...
    actualizarTarjetasParticipantes(
      "participantes-seleccionados-edicion",
      "input-participantes-edicion",
      Array.from(participantesSeleccionados)
    );
  }

  function actualizarTarjetasParticipantes(
    containerId,
    inputContainerId,
    participantes
  ) {
    ...
    if (!participantesContainer || !inputContainer) {
      console.error(
        "No se encontraron los elementos necesarios para mostrar los participantes"
      );
      return;
    }
  ...
  btnConfirmarParticipantes.onclick = function () {
    participantesSeleccionados.clear();
    document
      .querySelectorAll(".checkbox-usuario:checked")
      .forEach((checkbox) => {
  ...
  document
    .getElementById("confirmarParticipantes")
    .addEventListener("click", function () {
