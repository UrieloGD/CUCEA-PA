...
const enlacesDepartamentos = document.querySelectorAll('.contenedor-departamentos a');
...
const alternarBusqueda = () => {
  ...
  entradaBusqueda.style.display = entradaBusqueda.style.display === 'none' ? 'inline-block' : 'none';
}

// Agregar evento de clic al ícono de búsqueda
document.getElementById('icono-buscador').addEventListener('click', alternarBusqueda);
...
document.getElementById('icono-filtros').addEventListener('click', manejarFiltros);
