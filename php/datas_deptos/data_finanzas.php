...
$sql = "SELECT * FROM data_finanzas LIMIT $registros_por_pagina OFFSET $offset";
$result = mysqli_query($conexion, $sql);

// Obtener el total de registros
$total_registros = mysqli_num_rows(mysqli_query($conexion, "SELECT * FROM data_finanzas"));
...
<div class="cuadro-principal">
    <div class="encabezado">
        <div class="titulo-bd">
            <h3>Data - <?php echo $_SESSION['Nombre_Departamento']?></h3>
        </div>
