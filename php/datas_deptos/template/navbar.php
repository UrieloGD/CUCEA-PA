        ...
        <ul class="navbar-items flexbox-col">
            ...
            if ($rol_id == 1) {
                ...
                if (isset($_SESSION['Nombre_Departamento'])) {
                    ...
                    // Construir la URL utilizando una ruta relativa
                    $url = "./data_deptos/data_$nombre_departamento.php";
                    // Verificar si la URL actual coincide con la URL de destino
                    $current_url = basename($_SERVER['PHP_SELF']);
                    $target_url = basename($url);
                    if ($current_url == $target_url) {
                        // El usuario ya está en esta página, mostrar el texto sin enlace
                        echo "<span class='navbar-item-inner flexbox-left'>";
                    } else {
                        // El usuario puede hacer clic para ir a la página
                        echo "<a class='navbar-item-inner flexbox-left' href='$url'>";
                    }
                } else {
                ...
                echo "<a class='navbar-item-inner flexbox-left' href='./php/datas_deptos/data_departamentos.php'>";
            } else {
